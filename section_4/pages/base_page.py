...
class BasePage:
    # Подсказка типов browser: WebDriver
    ...
    # Элемент исчезает в течении заданного времени
    ...
    def go_to_basket_page(self):
        button_go_to_basket = self.browser.find_element(
            *BasePageLocators.BUTTON_GO_TO_BASKET
        )
